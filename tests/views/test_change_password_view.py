...
class TestChangePasswordView:
    ...
    @patch("views.change_password_view.render_template")
    ...
    def test_get_with_expired_token(self, mock_render_template):
        ...
        with patch("views.change_password_view.URLSafeTimedSerializer") as mock_serializer_class:
    ...
    @patch("views.change_password_view.render_template")
    @patch("views.change_password_view.URLSafeTimedSerializer")
