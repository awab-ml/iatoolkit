...
class TestGoogleDriveConnector(unittest.TestCase):
    def setUp(self):
        ...
        self.build_patch = patch('infra.connectors.google_drive_connector.build')
        ...
        self.credentials_patch = patch('infra.connectors.google_drive_connector.Credentials.from_service_account_file')
    ...
    def test_get_file_content_success(self):
        ...
        with patch('infra.connectors.google_drive_connector.MediaIoBaseDownload', return_value=mock_downloader):
