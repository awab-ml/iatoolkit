...
class TestDatabaseManager(unittest.TestCase):
    ...
    @patch('repositories.database_manager.create_engine')
    @patch('repositories.database_manager.sessionmaker')
    @patch('repositories.database_manager.scoped_session')
    ...
    @patch('repositories.database_manager.Base.metadata.create_all')
    ...
    @patch('repositories.database_manager.Base.metadata.drop_all')
